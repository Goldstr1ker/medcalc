...
export interface Calculator {
  ...
  updated: string;
  /**
   * Версия содержимого калькулятора в формате «мажор.минор», строкой.
   *
   * Мажор — смена самой формулы, шкалы или порогов (результат для тех же
   * входных данных стал другим). Минор — правки текстов, источников,
   * ограничений, границ ввода: расчёт прежний, обвязка обновилась.
   *
   * Строкой, а не числом: у числа 1.10 неотличимо от 1.1, и десятое
